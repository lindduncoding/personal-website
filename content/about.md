+++
title = "About"
description = "The first point of OSINT to investigate my life"
date = "2004-05-30"
aliases = ["about", "contact"]
author = "Fidelya Fredelina"
+++

Fidelya Fredelina, also known online as _fidelyafr_ (and many other usernames she will NOT disclose) is an Indonesian IT enthusiast whose interest spans multiple domains from **data**, **network**, **security** and recently, **wireless engineering.** She will touch anything as long as it's not software engineering. 

She obtained her Bachelor's in Engineering from [Universitas Gadjah Mada](https://ugm.ac.id), majoring in Information Technology. She won't consider herself a _social_ person but she was quite active during her university life where her involvement peaked at becoming a Vice President of [Night Login](https://www.instagram.com/nightlogin/).
